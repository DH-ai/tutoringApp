...
class SessionsModel(models.Model):
    ...
    students_lists = models.ManyToManyField(User, through='SessionBooking')
...
class SessionBooking(models.Model):
    session = models.ForeignKey(SessionsModel, on_delete=models.CASCADE, related_name='bookings')
